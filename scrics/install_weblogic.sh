...
v_software_jdk=$v_descarga_software"/jdk-7u79-linux-x64.tar.gz"
v_ruta_binarios="/u01/MIDWLS"$v_version
v_java=/u01/java/bin/java
v_template=template1036.jar
...
v_software=$v_descarga_software"/wls1036_generic.jar"
...
#Instalacion JVM
mkdir /u01/jdk
tar -xzvf $v_descarga_software"/jdk-7u79-linux-x64.tar.gz" -C /u01/jdk
...
echo "Arrancar weblogic:"
echo "/u01/domains/"$v_nombre_dominio
